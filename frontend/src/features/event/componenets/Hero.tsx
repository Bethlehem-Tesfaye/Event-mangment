...
export function Hero() {
  ...
  return (
    <section className=" max-w-7xl mx-auto relative h-[400px] bg-gradient-to-r from-gray-600 via-gray-400 to-gray-700 text-white overflow-hidden animate-gradient rounded-2xl">
